...
class AnalyticsSummary(BaseModel):
    ...
    total_quizzes_taken = Column(
        Integer,
        default=0,
        nullable=False,
    )

    total_quiz_score = Column(
        Float,
        default=0.0,
        nullable=False,
    )
    ...
    total_flashcards_reviewed = Column(
        Integer,
        default=0,
        nullable=False,
    )

    total_coding_problems_solved = Column(
        Integer,
        default=0,
        nullable=False,
    )
...
class ActivityLog(BaseModel):
    ...
    # but use "activity_metadata" in Python.
