        ...
        {loading ? (
          ...
          <div>
            <div
              ...
              className="card p-8 min-h-[280px] flex flex-col items-center justify-center cursor-pointer select-none hover:shadow-soft transition-all duration-300 relative"
            >
              ...
              <p className="text-center text-lg font-medium text-slate-700 dark:text-slate-200 leading-relaxed">
