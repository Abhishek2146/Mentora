      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {[
            ...
            { label: "Quiz Average", value: "78%", change: "+5%", icon: Trophy, color: "text-success-600", bg: "bg-success-50 dark:bg-success-900/30" },
            ...
            { label: "Topics Mastered", value: "9/18", change: "+1", icon: Target, color: "text-primary-600", bg: "bg-primary-50 dark:bg-primary-900/30" },
          ].map((s) => (
            <div key={s.label} className="stat-card">
              ...
              <span className="text-xs font-semibold text-success-600 bg-success-50 dark:bg-success-900/30 px-2 py-0.5 rounded-full">{s.change} this week</span>
            </div>
          ))}
        </div>
            ...
            {tasks.map((t) => (
              <div key={t.id} className={`flex items-center gap-3 p-3 rounded-xl border transition-all ${
                ...
                <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all ${
                  t.done ? "bg-success-500 border-success-500" : "border-slate-300 dark:border-slate-500"
                }`}>
                ...
                <span className={`flex-1 min-w-0 text-sm font-medium ${t.done ? "line-through text-slate-400" : "text-slate-700 dark:text-slate-200"}`}>{t.title}</span>
